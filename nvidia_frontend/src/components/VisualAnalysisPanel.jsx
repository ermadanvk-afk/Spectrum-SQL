  ...
  return (
    <div style={isFullscreen ? {
      ...
      <div style={{ flex: 1, width: '100%' }}>
        ...
        {status === 'error' && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#ef4444', padding: '20px', textAlign: 'center', minHeight: '180px' }}>
            <AlertCircle size={32} style={{ marginBottom: '12px' }} />
            <span style={{ fontSize: '0.95rem', fontWeight: 500, marginBottom: '8px' }}>Chart couldn't render</span>
